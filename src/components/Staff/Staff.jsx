const Staff = (props) => {
    ...
    ***************************************/
    const parentStyle = {
        display: props.activePage === 'staff' ? 'flex' : 'none',
        marginTop: '30px',
